{ pkgs, attrs, username, host-name, version, lib, ... }:
{
  ...
  systemd.tmpfiles.rules = [
    ...
    "L+ /home/${username}/.local/state/nix/profiles/profile 0755 ${username} /home/${username}/.local/state/nix/profiles/tmp"
    "L+ /home/${username}/.nix-profile 0755 ${username} /home/${username}/.local/state/nix/profiles/profile"
